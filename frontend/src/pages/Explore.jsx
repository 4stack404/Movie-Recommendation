...
const Explore = () => {
  ...
  const LatestMoviesHero = () => {
    ...
    return (
      ...
      >
        {/* Carousel Slides */}
        <div className="relative w-full h-[70vh] sm:h-[80vh] md:h-[85vh] lg:h-[92vh] overflow-hidden bg-black">
            ...
            >
              ...
              <div className="absolute inset-0 bg-black">
                <img 
                  ...
                  alt={movie.title}
                  className="w-full h-full object-cover object-center object-[center_55%]"
                  onError={(e) => {
              ...
              <div className="absolute bottom-0 left-0 w-full px-4 sm:px-8 md:px-16 pb-12 sm:pb-16 md:pb-20 z-20">
